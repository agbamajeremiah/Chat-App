...
class AppColors {
  static Color primaryColor = Color(0xff072F5f);//
  static Color accentColor = Color(0xff484848);
  static Color secondaryColor = Color(0xfff0f7fe);
  ...
  static Color splashBlue = Color(0xff00a2ed);
  static Color lightBlue = Color(0xffA0C2EB);
  static Color containerShadow = Color(0xffE5E5E5);

  static Color greyColor = Color(0xffF2F4F4);
  static Color bgGrey = Color(0xFFF7F7F7); //0xFFEAEAEA

  //Dark Color
  static Color darkPrimaryColor = Color(0xff474A57);
